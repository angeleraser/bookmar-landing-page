<template>
	<section class="download-extension">
		...
		<div class="cards-container">
			...
			></card-base>
			<card-base :browser="{ name: 'Firefox', version: 55 }"
				><svg xmlns="http://www.w3.org/2000/svg" width="105" height="100">
					...
					/></svg
			></card-base>
			<card-base :browser="{ name: 'Opera', version: 46 }"
...
.download-extension .cards-container .card-base:not(:last-child) {
	margin-bottom: 38px;
}
...
@media screen and (min-width: 1024px) {
	...
	.download-extension .cards-container .card-base:nth-child(2) {
		margin-top: 60px;
	}

	.download-extension .cards-container .card-base:nth-child(3) {
		margin-top: 120px;
	}
}
</style>
